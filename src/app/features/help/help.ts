      ...
      items: [
        {
          ...
          answer:   'Ve a Tareas → "Nueva Tarea". Completa el título, categoría, turno y selecciona al colaborador asignado. Solo GERENTE y ADMIN pueden crear tareas. Una vez guardada, el colaborador recibirá una notificación en tiempo real.',
        },
        {
          id: 't2',
